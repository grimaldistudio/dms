    ...
    public function rules()
    {
        return array(
           ...
           // array('identifier', 'unique', 'on'=>'protocol,publish,protocol_admin,publish_admin'),
            ...
            array('publication_date_from', 'date', 'format'=>'dd/MM/yyyy', 'timestampAttribute'=>'publication_date_from', 'allowEmpty' =>true, 'on'=>'publish,publish_admin'),          
            array('publication_date_to', 'date', 'format'=>'dd/MM/yyyy', 'timestampAttribute'=>'publication_date_to', 'allowEmpty' =>true, 'on'=>'publish,publish_admin'),          
