...
<?php echo $form->textFieldRow($model, 'spending_date', array('class' => 'date_field', 'value'=>$model->spending_date>0?date('d/m/Y', is_int($model->spending_date)?$model->spending_date:strtotime($model->spending_date)):'')); ?>
    ...
    <div class="span4">
        ...
        <div id="cv-box">
            ...
            <div id="cv-container">
                <?php if($model->hasCV()): ?>
                    <?php echo $model->getCVName(true); ?> (<?php echo $model->getCVSize(true); ?>) KB <?php echo CHtml::link('  ', array('/spending/deletecv'), array('class'=>'icon-trash delete-file-button')); ?>
                <?php endif; ?>
            </div>
        </div>
        ...
        <div id="contract-box">
            ...
            <div id="contract-container">
                <?php if($model->hasContract()): ?>
                    <?php echo $model->getContractName(true); ?> (<?php echo $model->getContractSize(true); ?> KB) <?php echo CHtml::link('  ', array('/spending/deletecontract'), array('class'=>'icon-trash delete-file-button')); ?>
                <?php endif; ?>
            </div>
        </div>
        ...
        <div id="project-box">
            ...
            <div id="project-container">
                <?php if($model->hasProject()): ?>
                    <?php echo $model->getProjectName(true); ?> (<?php echo $model->getProjectSize(true); ?> KB) <?php echo CHtml::link('  ', array('/spending/deleteproject'), array('class'=>'icon-trash delete-file-button')); ?>
                <?php endif; ?>
            </div>
        </div>
        ...
        <div id="capitulate-box">
            ...
            <div id="capitulate-container">
                <?php if($model->hasCapitulate()): ?>
                    <?php echo $model->getCapitulateName(true); ?> (<?php echo $model->getCapitulateSize(true); ?> KB) <?php echo CHtml::link('  ', array('/spending/deletecapitulate'), array('class'=>'icon-trash delete-file-button')); ?>
                <?php endif; ?>
            </div>
        </div>
        ...
        <div id="other-box">
            ...
            <div id="other-container">
                <?php foreach($model->listOtherDocuments(true) as $other): ?>
                    <div class="other-file-item"><?php echo $other; ?> (<?php echo $model->getOtherSize($other, true); ?> KB) <?php echo CHtml::link('  ', array('/spending/deleteother', 'filename'=>$other), array('class'=>'icon-trash delete-other-file-button')); ?></div>
                <?php endforeach; ?>
            </div>
            <?php $style = ''; ?>
            <?php if(!$model->canAddNewOther(true)) $style = 'display:none'; ?>
...
<?php $form = $this->beginWidget('bootstrap.widgets.BootActiveForm', array(
    'id'=>'cv-upload-form',
    'action'=>array('/spending/uploadcv'),
...
<?php $form = $this->beginWidget('bootstrap.widgets.BootActiveForm', array(
    ...
    'action'=>array('/spending/uploadcontract'),
    'htmlOptions'=>array('class'=>'well', 'enctype'=>'multipart/form-data'),
    'enableClientValidation'=>true,
    'clientOptions'=>array(
        'validateOnSubmit'=>true,
...
<?php $form = $this->beginWidget('bootstrap.widgets.BootActiveForm', array(
    ...
    'action'=>array('/spending/uploadproject'),
    'htmlOptions'=>array('class'=>'well', 'enctype'=>'multipart/form-data'),
    'enableClientValidation'=>true,
    'clientOptions'=>array(
        'validateOnSubmit'=>true,
...
<?php $form = $this->beginWidget('bootstrap.widgets.BootActiveForm', array(
    ...
    'action'=>array('/spending/uploadcapitulate'),
    'htmlOptions'=>array('class'=>'well', 'enctype'=>'multipart/form-data'),
    'enableClientValidation'=>true,
    'clientOptions'=>array(
        'validateOnSubmit'=>true,
...
<?php $form = $this->beginWidget('bootstrap.widgets.BootActiveForm', array(
    ...
    'action'=>array('/spending/uploadother'),
    'htmlOptions'=>array('class'=>'well', 'enctype'=>'multipart/form-data'),
    'enableClientValidation'=>true,
    'clientOptions'=>array(
        'validateOnSubmit'=>true,
...
//Yii::app()->clientScript->registerCssFile('/css/fileuploader.css');
...
Yii::app()->clientScript->registerScript('spending-create-form', "
    ...
    $('#cv-upload-button').live('click', function(e){
        $('#cv-upload-dialog').modal('show');
    });
    
    $('#project-upload-button').live('click', function(e){
        $('#project-upload-dialog').modal('show');
    });
    
    $('#contract-upload-button').live('click', function(e){
        $('#contract-upload-dialog').modal('show');
    });
    
    $('#capitulate-upload-button').live('click', function(e){
        $('#capitulate-upload-dialog').modal('show');
    });
    
    $('#other-upload-button').live('click', function(e){
